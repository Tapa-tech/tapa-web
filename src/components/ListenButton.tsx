...
export default function ListenButton({
  ...
  const handlePlayPause = (e: React.MouseEvent) => {
    ...
    if (audioUrl) {
      ...
      if (isPlaying) {
        ...
        stopSpeaking();
        // Dispatch custom event to notify other ListenButtons to stop
    ...
    if (isPlaying) {
      ...
      // Dispatch custom event to stop all other playing instances
      window.dispatchEvent(new CustomEvent("tapa-tts-stop-all"));
  ...
  // Listen to the custom event to stop playback if another speaker starts
  useEffect(() => {
    const handleStopAll = () => {
      if (audioUrl) {
